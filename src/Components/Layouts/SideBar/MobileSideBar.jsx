...
function MobileSideBar() {
  ...
  useEffect(() => {
    ...
    if (sideBarOpen) {
      ...
      childrenOverlay.classList.remove("opacity-0", "hidden");
      ...
      childrenOverlay.classList.add("opacity-0", "hidden");
  ...
  return (
    <div
      ref={sideRef}
      className={`absolute top-0 w-[290px] h-screen z-20 transition-all duration-500 lg:hidden overflow-hidden ${
    ...
    >
      ...
      {/* Sidebar Content */}
      <div className="boxBg w-full h-full flex flex-col">
        <Profile
