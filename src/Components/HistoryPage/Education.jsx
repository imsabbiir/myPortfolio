...
const educationData = [
  ...
  },
  {
    id: 2,
    title: "Diploma",
    address: "Saheb Protab, Police Line, Narsingdi",
  ...
  },
  {
    id: 3,
    title: "HSC",
    address: "Kanchon, Rupganj, Narayanganj",
    institute: "Salimuddin Chowdhory University",
    department: "Arts",
    year: "2020-2021",
  },
];
      ...
      <div className="lists mt-6">
        <div className="flex flex-col gap-8 w-[85%]">
          {educationData?.map((education, index) => {
            return (
              <div key={index} className="w-full historyBox p-5 box">
                <div className="flex justify-between items-center">
                  <h2 className="font-medium titleText text-xs md:text-base">
                    {education.title}
                  </h2>
                ...
                <div className="mt-7 mb-5 flex flex-col gap-2 text-xs">
                  <h1 className="font-medium titleText">
                    Institute:{" "}
                    <span className="subTitleText">{education.institute}</span>
                  </h1>
                  <h1 className="font-medium titleText">
                    Department:{" "}
                    <span className="subTitleText">{education.department}</span>
                  </h1>
                </div>
                <Link
                  href={""}
                  className="activeText cursor-pointer font-semibold flex items-center text-xs w-fit"
                >
